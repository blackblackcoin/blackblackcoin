...
---------------------
	...
	cd src/
	make -f makefile.unix		# Headless BBCoin

See readme-qt.rst for instructions on building BBCoin-Qt, the graphical user interface.
...
---------------------
 ...
 libcrypto++ Cryptography      Provides implementations for cryptography in BBCoin
...
Notes
-----
The release is built with GCC and then `strip BBCoind` to strip the debug
...
Security
--------
To help make your BBCoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, BBCoin should be built with a non-executable stack
