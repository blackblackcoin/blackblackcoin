    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a BBCoin address (e.g. mhN8btKtp3HrXgZJwyBakUzALLZ34nA4J)"));
    ui->pubkeyOut_VM->setPlaceholderText(tr("Click \"Sign Message\" to view public key"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a BBCoin address (e.g. mhN8btKtp3HrXgZJwyBakUzALLZ34nA4J)"));
