    ...
    QSplashScreen(pixmap, f)
{
    ...
    //QString copyrightText   = QChar(0xA9)+QString(" 2009-2014 ") + QString(tr("The Bitcoin developers"));
    //QString copyrightText2  = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The BBCoin developers"));
