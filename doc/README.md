...
Intro
---------------------
BBCoin is a free open source peer-to-peer electronic cash system that is
...
Setup
---------------------
You need the Qt4 run-time libraries to run BBCoin-Qt. On Debian or Ubuntu:
	`sudo apt-get install libqtgui4`

Unpack the files into a directory and run:

- bin/32/BBCoin-qt (GUI, 32-bit)
- bin/32/BBCoind (headless, 32-bit)
- bin/64/BBCoin-qt (GUI, 64-bit)
- bin/64/BBCoind (headless, 64-bit)
