...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click BBCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start BBCoin: click-to-pay handler");
    else
...
{
    // clicking on BBCoin: URLs creates FileOpen events on the Mac:
