...
// Copyright (c) 2014 The BBCoin developers
...
uint256 hashGenesisBlock("00000059fad3fe58ae445df7988969c7e7f8d283d893f2c144327dd423852acb");
static const unsigned int timeGenesisBlock = 1397808000;
static const unsigned int nNonceGenesisBlock = 7285374;
...
static const int64 nTargetTimespan = 2 * 60; // BBCoin: 1 minutes
static const int64 nTargetSpacing = 60; // BBCoin: 1 minutes
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // BBCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
{
        static const int64 BlocksTargetSpacing = 2 * 60; // 2 miniute
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0000005abd0a3556a7045f18e5d7834c34cb26fe3b91579e503757120fdf093f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "Keccak";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04abb9f3e9f8d893bfd86cb8ca1e623ca96087f2ba90a9707128894b18365e6095b91a14ff080c9e5f33867e87da06ca48396c16aa44db3726df334e5bf2ef849b") << OP_CHECKSIG;
        CBlock block;
        ...
        assert(block.hashMerkleRoot == uint256("b7e50d3d3b308f307b8c3f94eabf7beb9cfa369dabaa577eac98658549200fdd"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BBCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BBCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("BBCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("BBCoin-miner");
    ...
    try { while(true) {
        ...
        printf("Running BBCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
